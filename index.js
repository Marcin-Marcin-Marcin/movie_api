...
app.use(cors());
//Replace the line above with the code below if you want only certain origins to be given access. It checks if the request’s domain is in the allowedOrigins list—if it is, the request is allowed; if not, it’s rejected.
